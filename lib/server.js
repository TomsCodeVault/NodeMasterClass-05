...
server.router = {
  ...
  'order/history' : handlers.orderHistory,
  'order/detail' : handlers.orderDetail,
  'api/users' : handlers.users,
  'api/tokens' : handlers.tokens,
  'api/menu' : handlers.menu,
  'api/orders' : handlers.orders,
  'api/carts' : handlers.carts,
  'api/carts/items/add' : handlers.carts,
  'api/carts/items/update' : handlers.carts,
  'api/carts/items/remove' : handlers.carts,
  'api/carts/items/empty' : handlers.carts,
  'favicon.ico' : handlers.favicon,
  'public' : handlers.public,
  'example/errors' : handlers.exampleError
};
